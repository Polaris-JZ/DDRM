...
dims_list = ['[300,1000]']
# dims_list = ['[300,1000]','[200,600]', '[300,600]', '[200,1000]', '[500,1000]', '[400,1000]', '[200,1200]']
act_list = ['sigmoid']

# diff
# steps_list = [30,50,70,90]
steps_list = [3]

# sample_steps_list = [1, 1.25, 1.5, 2]
sample_steps_list = [1]
...
beta_list = [0.5]
# beta_list = [0, 0.05, 0.1, 0.3, 0.5, 0.7, 0.9]
